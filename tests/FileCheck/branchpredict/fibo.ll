; ModuleID = '/tmp/a.ll'
source_filename = "../swpp202301-compiler-team6/input/bp-fibo.c"
...
; CHECK:   for.cond:
; CHECK:   [[CMP:%.*]] = icmp ugt i64 [[CONV:%.*]], [[CALL:%.*]]
...
for.cond:                                         ; preds = %for.inc, %entry
  %b.0 = phi i64 [ 1, %entry ], [ %add, %for.inc ]
  %a.0 = phi i64 [ 1, %entry ], [ %b.0, %for.inc ]
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @write(i64 noundef %b.0)
  ret i32 0
}
