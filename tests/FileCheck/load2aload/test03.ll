...
; CHECK: shl i64 [[I]], 5
; CHECK: store i64 {{.*}}, i64* [[P]]
; CHECK-NEXT: [[V:%.*]] = call i64 @aload_i64(i64* [[P]])
; CHECK: mul nsw i64
; CHECK: add nsw i64
...
for.body:                                         ; preds = %for.cond
  ...
  store i64 %add9, i64* %add.ptr, align 8
  %mul = mul nsw i64 %i.0, %i.0
  %mul10 = mul nsw i64 %mul, %i.0
  %mul11 = mul nsw i64 2, %i.0
  ...
  call void @write(i64 noundef %add13)
  br label %for.inc
